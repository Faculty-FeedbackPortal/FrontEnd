...
export default function ACTheoryQ() {
    ...
    async function addQs() {
        ...
        await axios.post("http://localhost:8000/api/theoryquest/", qDum, {
            headers: {
    ...
    async function fetchAllQs() {
        axios.get("http://localhost:8000/api/theoryquest/", {
            headers: {
                'Authorization': `Token ${getCookie('token')}`
            }
        })
            ...
            <div className="divf fdirc fullbg dashMain">
                ...
                <section className="paddM">
                    <div className="divf jusSB">
                        <p className="dashTT1">Theory Questions</p>
                        <Button className="muiButOut" variant="outlined" endIcon={<AddCircleRounded />} onClick={handleOpen}>Add Theory Question</Button>
                        <Modal
                            open={open}
                            onClose={handleClose}
